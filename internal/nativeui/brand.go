...
// screen: the NATS "N" logo flanking "JETRICKS: peer to peer blackboard system made with
// NATS.io".
	...
	return layout.Inset{Top: unit.Dp(12), Bottom: unit.Dp(2)}.Layout(gtx, func(gtx C) D {
		return layout.Center.Layout(gtx, func(gtx C) D {
			return layout.Flex{Alignment: layout.Middle}.Layout(gtx,
				...
				layout.Rigid(a.pixel(unit.Sp(12), " JETRICKS: peer to peer blackboard system made with ", colFg).Layout),
