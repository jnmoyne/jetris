...
If you don't know how to run an unsigned binary you downloaded from GitHub don't worry it's very straightforward, see the following simple instructions:

Mac OSX: https://youtu.be/o4-sX9Tydz0, Windows: https://share.google/aimode/MOdkf4QbNr2g9bhZB
...
***How it was coded***
Jetris also started as one of my first experiments with using coding agents (Claude in this case) to generate the code via (a lot of) prompting with very explicit design choices and explanations in md files, and then only some editing of the generated code as needed.
---
