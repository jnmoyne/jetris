...
func TestClearPointsTable(t *testing.T) {
	cases := []struct {
		...
		{"b2b tetris", Clear{Lines: 4, BackToBack: true}, 1200},
		...
		{"tetris perfect clear", Clear{Lines: 4, Perfect: true}, 2800},
		{"b2b tetris perfect clear", Clear{Lines: 4, BackToBack: true, Perfect: true}, 4400},
...
func TestClearAttackRows(t *testing.T) {
	cases := []struct {
		...
		// Back-to-Back bonus: +1 MTSS/MTSD/TSS, +2 TSD/Tetris, +3 TST.
		...
		{"b2b tetris", Clear{Lines: 4, BackToBack: true}, 6},
		...
		{"tetris perfect clear", Clear{Lines: 4, Perfect: true}, 14},
		{"b2b tetris perfect clear", Clear{Lines: 4, BackToBack: true, Perfect: true}, 16},
