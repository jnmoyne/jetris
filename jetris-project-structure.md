...
│   ├── voice/                        ← the in-game voice chat (§22): codec, gate, jitter, session, devices
│   │   ├── packet.go
│   │   ├── codec.go
│   │   ├── vad.go
│   │   ├── jitter.go
...
**Files:** `packet.go`, `codec.go`, `vad.go`, `jitter.go`, `mixer.go`, `resample.go`, `session.go`, `device.go`, `device_malgo.go` (`!js && cgo`), `device_none.go` (`!js && !cgo`), `device_js.go` + `worklet_js.go` (`js`).
